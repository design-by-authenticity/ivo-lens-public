...
A distinction can be valid locally without being valid globally. Every substantive claim should therefore be located across relevant axes such as:
...
The lens distinguishes between assumptions that are:

- imported from ordinary language or another domain;
- empirically established;
- native to the framework;
- adopted temporarily for a specific analysis;
- constitutive of the instrument itself.

Constitutive assumptions cannot be neutrally adjudicated by the lens when the lens's own operation depends on them. In such cases, refusing a closing synthesis can be more rigorous than forcing one.

## What the lens is not

The I·V·O Lens is not:

- a universal explanation of reality;
- a diagnostic classification system;
- a replacement for domain expertise;
- proof that every object contains a meaningful I·V·O structure;
- permission to convert speculation into observation;
- a guarantee that an AI model follows the instrument correctly.

Its value depends partly on whether it can reveal its own limits, assumptions, and failure modes.
