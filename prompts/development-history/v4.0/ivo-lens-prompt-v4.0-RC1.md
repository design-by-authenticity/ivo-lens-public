# I·V·O Lens Prompt v4.0 — Canonical Reference Version (RC1)
...
Depending on domain, an I-position may be a person, group, institution, organism, sensor, measuring apparatus, algorithm, analytical procedure, or another materially selective system.
...
13. Name evidence that could weaken or overturn the reconstruction.
...
When measurement, instrumentation, or intervention is present, first test it as a physical, informational, or relational event. Ask what relation was instantiated/altered, what changed in O/V, whether selective distinction occurred, and by which I.

Instrumentation is not automatically I.
...
A sensor/apparatus counts as I only insofar as a materially relevant selective function is established. Mere coupling, perturbation, transmission, or indiscriminate recording belongs under V/O as appropriate.
...
Check for hidden/imported assumptions; possibility/realization confusion; relation/change confusion; interaction/selectivity confusion; single-observer bias; single-field bias; artificial multiplication; formal availability versus functional reachability; field visibility; blind spots; scale transfer; domain-of-validity errors; properties mistaken for relations; unsupported causality; symmetry/asymmetry; unequal capacity to alter another position's O; descriptive versus normative language; evidence versus interpretation versus speculation; and testability.
...
Structurally changed: operator semantics; removal of mandatory two-perspective floor; explicit plural O/V/I; V reconstructed around instantiated relation; I around situated selectivity; cross-structure analysis added; Perspective Matrix replaced; formal availability versus functional reachability made explicit.

RC1 is not the frozen v4.0 release. Stress-test before Zenodo publication.
